...
__The 1.6.1 is the first version of the Gradle plugin__. As it reuses the plugin logic developped in the [graphql-maven-plugin-project](https://github.com/graphql-java-generator/graphql-maven-plugin-project) project, it inherits from all is history.


## You'll find below the history for this maven plugin: 
