 ...
 *
 * <p>
 * Proper root cause handling was added to the standard {@code IOException} in Java 6, which is why Spring originally
 * introduced {@code NestedIOException} for compatibility with versions prior to Java 6.
 *
 * <p>
